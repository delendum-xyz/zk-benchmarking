...
use benches::merkle_rescue_prime;
...
fn main() {
    ...
    if cli.command == Command::All || cli.command == Command::MerkleRescuePrime {
        run_jobs::<merkle_rescue_prime::Job>(&prover, &cli.out, merkle_rescue_prime::new_jobs());
    }
}
